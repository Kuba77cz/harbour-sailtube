...
dbus.files = cz.kuba77.SailTube.service
dbus.path = $$INSTALL_ROOT/usr/share/dbus-1/services

INSTALLS += dbus

openUrl.files = harbour-sailtube-open-url.desktop
